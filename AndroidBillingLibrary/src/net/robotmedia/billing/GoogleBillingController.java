...
import com.robobilling.AbstractBillingController;
import com.robobilling.event.BillingCheckedEvent;
import com.robobilling.event.PurchaseIntentEvent;
import com.robobilling.event.PurchaseStateChangeEvent;
import com.robobilling.event.RequestPurchaseResponseEvent;
import com.robobilling.event.SubscriptionCheckedEvent;
...
public class GoogleBillingController extends AbstractBillingController {
     ...
     * {@link GoogleBillingController#checkSubscriptionSupported(Context)}.
     * </p>
     *
     * @param context
     ...
     * @see GoogleBillingController#checkSubscriptionSupported(Context)
     */
    public BillingStatus checkBillingSupported(Context context) {
     ...
     * {@link GoogleBillingController#checkBillingSupported(Context)}.
     * </p>
     *
     * @param context
     ...
     * @see GoogleBillingController#checkBillingSupported(Context)
     */
    public BillingStatus checkSubscriptionSupported(Context context) {
     ...
     * received.
     *
     * Posts a {@link com.robobilling.event.BillingCheckedEvent} to the event bus
     *
     * @param supported
     */
     ...
     * received.
     *
     * Posts a {@link com.robobilling.event.PurchaseIntentEvent} to the event bus
     *
     ...
     *
     * Posts a {@link com.robobilling.event.PurchaseStateChangeEvent} to the event bus
     *
     ...
     * is received.
     *
     * Posts a {@link com.robobilling.event.SubscriptionCheckedEvent} to the event bus
     *
     * @param supported
     */
    ...
    /**
     * Posts a {@link com.robobilling.event.TransactionsRestoredEvent} to the event bus
     */
    ...
    /**
     * Posts a {@link com.robobilling.event.RequestPurchaseResponseEvent} to the event bus
     *
     * @param itemId
     * @param response
     */
